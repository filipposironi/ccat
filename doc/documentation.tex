...
morekeywords=[0]{defvar,loop,collect,for,from,to,define-variable,bezot,zot,asdf,operate,load-op,use-package},
keywordstyle=[0]\color{violet}\bfseries,
morekeywords=[1]{-A-,-E-,-P-},
...
\vskip 9cm
\begin{center}
{\Large Computer Controller Automatic Transmission\\(Mandatory Part and Optional Part)}
\end{center}
\vskip 2cm
\begin{center}
