...
morekeywords=[2]{Dist,Past,Futr,Lasted,Lasts,WithinP,WithinF,Som,SomP,SomF,Alw,AlwP,AlwF,UpToNow,NowOn,Until,Since},
...
\vskip 9cm
\begin{center}
{\Large Computer Controller Automatic Transmission\\(Mandatory Part, Optional Part coming soon)}
\end{center}
\vskip 2cm
\begin{center}
